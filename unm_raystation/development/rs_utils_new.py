        ...
        <Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" 
            ...
            <Grid Margin="10,10,10,10">
                ...
                <Grid Grid.Row="0" Margin="15,15,15,15">
                    ...
                    <TextBox Name="error_message" Grid.Column="0" HorizontalAlignment="Stretch" VerticalAlignment="Stretch" Margin="10" TextWrapping="Wrap" Text="" ScrollViewer.VerticalScrollBarVisibility="Auto" Width="Auto" Height="Auto"/>
                </Grid>
                <Grid Grid.Row="1" Margin="15,15,15,15">
                    ...
                    <Grid Grid.Row="1">
                        <TextBox Name="traceback_message" Grid.Column="0" HorizontalAlignment="Stretch" VerticalAlignment="Stretch" Margin="10" TextWrapping="Wrap" Text="" ScrollViewer.VerticalScrollBarVisibility="Auto" Width="Auto" Height="Auto"/>
                    </Grid>
                </Grid>
