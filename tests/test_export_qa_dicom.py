...
from unm_raystation.release.export_qa_dicom import *
...
def test_export_qa_instantiate(mock_get_current_helper, monkeypatch):
    monkeypatch.setattr(
        "unm_raystation.release.export_qa_dicom.get_current_helper",
